...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    renderCall: (_args: any, theme: any) => renderToolCall("subagent_spawn", theme),
  ...
  pi.registerTool({
    ...
    renderCall: (_args: any, theme: any) => renderToolCall("subagent_wait", theme),
    renderResult: (result: any, _options: any, theme: any) => renderToolResult(result, theme),
  ...
  pi.registerTool({
    ...
    renderCall: (_args: any, theme: any) => renderToolCall("subagent_cancel", theme),
    renderResult: (result: any, _options: any, theme: any) => renderToolResult(result, theme),
  ...
  pi.registerTool({
    ...
    renderCall: (_args: any, theme: any) => renderToolCall("subagent_check", theme),
    renderResult: (result: any, _options: any, theme: any) => renderToolResult(result, theme),
  ...
  pi.registerTool({
    ...
    renderCall: (_args: any, theme: any) => renderToolCall("subagent_list", theme),
    renderResult: (result: any, _options: any, theme: any) => renderToolResult(result, theme),
